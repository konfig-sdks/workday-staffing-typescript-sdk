...
/**
 * This class provides a wrapper for network errors when making requests to staffing
 */
export class WorkdayStaffingError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "WorkdayStaffingError";
