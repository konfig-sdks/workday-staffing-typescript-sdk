...
import { DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8AllOf } from './display-explicit-skill-representation-d6ca778018011000182fa5be1ae901a8-all-of';
 ...
 * 
 * @export
 * @interface DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8
 */
export interface DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8 {
    /**
     * Remote Skill ID for associated Remote Skill Item
     * @type {string}
     * @memberof DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8
     */
    'remoteID'?: string;
    /**
