 ...
 * 
 * @export
 * @interface JobProfileDetailView7deab99f645f10000bd5e61a1b780041AllOf
 */
export interface JobProfileDetailView7deab99f645f10000bd5e61a1b780041AllOf {
    /**
     * The description of the responsibilities and/or qualifications for the job profile.
     * @type {string}
     * @memberof JobProfileDetailView7deab99f645f10000bd5e61a1b780041AllOf
     */
    'summary'?: string;
    /**
