 ...
 * 
 * @export
 * @interface ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000AllOf
 */
export interface ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000AllOf {
    /**
     * The name of the skill from the external system
     * @type {string}
     * @memberof ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000AllOf
     */
